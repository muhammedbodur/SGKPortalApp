...
namespace SGKPortalApp.PresentationLayer.Services.ApiServices.Concrete.Siramatik
{
    public class KanalIslemApiService : IKanalIslemApiService
    {
        ...
        public async Task<ServiceResult<KanalIslemResponseDto>> CreateAsync(KanalIslemCreateRequestDto dto)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    ...
                    return ServiceResult<KanalIslemResponseDto>.Fail("Kanal işlem oluşturulamadı.");
                }
        ...
        public async Task<ServiceResult<KanalIslemResponseDto>> UpdateAsync(int id, KanalIslemUpdateRequestDto dto)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    ...
                    return ServiceResult<KanalIslemResponseDto>.Fail("Kanal işlem güncellenemedi.");
                }
        ...
        public async Task<ServiceResult<bool>> DeleteAsync(int id)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    ...
                    return ServiceResult<bool>.Fail("Kanal işlem silinemedi.");
                }
        ...
        public async Task<ServiceResult<List<KanalIslemResponseDto>>> GetByHizmetBinasiIdAsync(int hizmetBinasiId)
        {
            try
            {
                var response = await _httpClient.GetAsync($"kanalislem/hizmet-binasi/{hizmetBinasiId}");
