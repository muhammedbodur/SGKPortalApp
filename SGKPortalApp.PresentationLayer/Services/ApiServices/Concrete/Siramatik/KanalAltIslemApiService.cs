    ...
    public class KanalAltIslemApiService : IKanalAltIslemApiService
    {
        ...
        public async Task<ServiceResult<KanalAltIslemResponseDto>> CreateAsync(KanalAltIslemCreateRequestDto dto)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    var errorMessage = apiResponse?.Message ?? "Kanal alt işlem oluşturulamadı.";
                    _logger.LogError("CreateAsync failed: {Error}", errorMessage);
                    return ServiceResult<KanalAltIslemResponseDto>.Fail(errorMessage);
                }
        ...
        public async Task<ServiceResult<KanalAltIslemResponseDto>> UpdateAsync(int id, KanalAltIslemUpdateRequestDto dto)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    var errorMessage = apiResponse?.Message ?? "Kanal alt işlem güncellenemedi.";
        ...
        public async Task<ServiceResult<bool>> DeleteAsync(int id)
        {
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    var errorMessage = apiResponse?.Message ?? "Kanal alt işlem silinemedi.";
