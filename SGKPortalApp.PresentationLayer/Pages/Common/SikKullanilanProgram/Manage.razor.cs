    ...
    public partial class Manage
    {
        ...
        private async Task LoadData()
        {
            ...
            try
            {
                if (IsEditMode)
                {
                    var result = await _programService.GetByIdAsync(Id!.Value);
        ...
        private async Task HandleSubmit()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var result = await _programService.UpdateAsync(Id!.Value, request);
        ...
        private async Task ConfirmDelete()
        {
            ...
            try
            {
                var result = await _programService.DeleteAsync(Id!.Value);
                if (result.Success)
                {
