    ...
    public partial class SearchModal : IDisposable
    {
        ...
        private void InitializeSearchItems()
        {
            AllSearchItems = new List<SearchItem>
            {
                ...
                new SearchItem { Title = "Hizmet Binaları", Url = "/common/hizmet-binasi", Icon = "bx bx-building", Category = "Ortak İşlemler", PermissionKey = "COM.HIZMETBINASI.INDEX" },
                ...
                new SearchItem { Title = "Alt Kanallar", Url = "/siramatik/kanal-alt", Icon = "bx bx-subdirectory-right", Category = "Sıramatik İşlemleri", PermissionKey = "SIR.KANALALT.INDEX" },
                ...
                new SearchItem { Title = "Kiosk Cihazları", Url = "/siramatik/kiosk", Icon = "bx bx-devices", Category = "Sıramatik İşlemleri", PermissionKey = "SIR.KIOSK.INDEX" },
                ...
                new SearchItem { Title = "Yetki Atama", Url = "/yetki/yetki-atama", Icon = "bx bx-user-check", Category = "Yetki Yönetimi", PermissionKey = "YET.PERSONELYETKI.INDEX" },
