namespace SGKPortalApp.ApiLayer.Services.Hubs.Constants
{
    ...
    public static class SignalREvents
    {
        ...
        /// <summary>Panel yenilemesi gerektiğinde tetiklenir</summary>
        public const string RefreshPanel = "refreshPanel";

        /// <summary>Sıra listesi güncelleme payload'ı (APPEND/REMOVE/INSERT/REFRESH)</summary>
        public const string SiraListUpdate = "siraListUpdate";
