...
namespace SGKPortalApp.DataAccessLayer.Migrations
{
    ...
    [Migration("20251118204209_mig_5")]
    partial class mig_5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KioskIslemleri", b =>
                {
                    b.Property<int>("KioskIslemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("KioskIslemId"));
                    ...
                    b.HasKey("KioskIslemId");

                    b.HasIndex("KioskId");

                    b.ToTable("SIR_KioskIslemleri", "dbo");
                });

            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KioskKanalAltIslem", b =>
                {
                    b.Property<int>("KioskKanalAltIslemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("KioskKanalAltIslemId"));
                    ...
                    b.HasKey("KioskKanalAltIslemId");

                    b.HasIndex("KanalAltIslemId");

                    b.HasIndex("KioskIslemId", "KanalAltIslemId")
                        .IsUnique()
                        .HasDatabaseName("IX_SIR_KioskKanalAltIslem_KioskIslem_KanalAltIslem")
                        .HasFilter("[SilindiMi] = 0");

                    b.ToTable("SIR_KioskKanalAltIslem", "dbo");
                });
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.Kiosk", b =>
                {
                    ...
                    b.HasOne("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KioskMenu", "KioskMenu")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_SIR_Kiosk_SIR_KioskMenuTanim");
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KioskIslemleri", b =>
                {
                    b.HasOne("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.Kiosk", "Kiosk")
                        .WithMany("KioskIslemleri")
                        .HasForeignKey("KioskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_SIR_KioskIslemleri_SIR_KioskTanim");
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KioskKanalAltIslem", b =>
                {
                    b.HasOne("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KanalAltIslem", "KanalAltIslem")
                        .WithMany("KioskKanalAltIslemleri")
                        .HasForeignKey("KanalAltIslemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_SIR_KioskKanalAltIslem_SIR_KanalAltIslemleri");

                    b.HasOne("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KioskIslemleri", "KioskIslem")
                        .WithMany("KioskKanalAltIslemleri")
                        .HasForeignKey("KioskIslemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_SIR_KioskKanalAltIslem_SIR_KioskIslemleri");

                    b.Navigation("KanalAltIslem");

                    b.Navigation("KioskIslem");
                });
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KanalAltIslem", b =>
                {
                    ...
                    b.Navigation("KioskKanalAltIslemleri");
