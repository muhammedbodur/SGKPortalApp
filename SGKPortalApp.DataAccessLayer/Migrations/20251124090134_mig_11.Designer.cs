...
namespace SGKPortalApp.DataAccessLayer.Migrations
{
    ...
    [Migration("20251124090134_mig_11")]
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.Common.HubConnection", b =>
                {
                    ...
                    b.HasIndex("TcKimlikNo")
                        .IsUnique()
                        .HasDatabaseName("IX_CMN_HubConnections_TcKimlikNo")
                        .HasFilter("[SilindiMi] = 0");

                    b.HasIndex("TcKimlikNo", "ConnectionId", "ConnectionStatus")
                        .HasDatabaseName("IX_CMN_HubConnections_Tc_ConnId_Status");
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.HubBankoConnection", b =>
                {
                    ...
                    b.HasIndex("BankoId", "ConnectionId", "ConnectionStatus")
                        .HasDatabaseName("IX_SIR_HubBankoConnections_Banko_ConnId_Status");
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KioskMenuAtama", b =>
                {
                    ...
                    b.HasIndex("KioskId", "KioskMenuId")
                        .IsUnique()
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.Common.HubConnection", b =>
                {
                    b.HasOne("SGKPortalApp.BusinessObjectLayer.Entities.Common.User", "User")
                        ...
                        .HasForeignKey("SGKPortalApp.BusinessObjectLayer.Entities.Common.HubConnection", "TcKimlikNo")
