...
namespace SGKPortalApp.DataAccessLayer.Migrations
{
    ...
    [Migration("20251119131325_mig_7")]
    partial class mig_7
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KioskMenuIslem", b =>
                {
                    ...
                    b.Property<int?>("KanalAltIslemId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("KanalAltIslemId")
                        .HasDatabaseName("IX_SIR_KioskMenuIslem_KanalAltIslemId");

                    b.HasIndex("KanalAltIslemId1");
            ...
            modelBuilder.Entity("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KioskMenuIslem", b =>
                {
                    b.HasOne("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KanalAltIslem", "KanalAltIslem")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_SIR_KioskMenuIslem_SIR_KanalAltIslem");

                    b.HasOne("SGKPortalApp.BusinessObjectLayer.Entities.SiramatikIslemleri.KanalAltIslem", null)
                        .WithMany("KioskMenuIslemleri")
                        .HasForeignKey("KanalAltIslemId1");
