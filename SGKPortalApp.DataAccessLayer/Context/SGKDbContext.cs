...
namespace SGKPortalApp.DataAccessLayer.Context
{
    public class SGKDbContext : DbContext
    {
        ...
        public DbSet<DuyuruResim> DuyuruResimler { get; set; }
        ...
        private void ApplyEntityConfigurations(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new DepartmanHizmetBinasiConfiguration());
            ...
            modelBuilder.ApplyConfiguration(new DuyuruResimConfiguration());
